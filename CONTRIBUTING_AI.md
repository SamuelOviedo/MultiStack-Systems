...
### Antes de pedir un cambio en estas zonas, leer PROJECT_CONTEXT.md → Riesgos
...
**Naming:** ver tabla en PROJECT_CONTEXT.md → Convenciones
...
Referencia: PROJECT_CONTEXT.md está en la raíz con la arquitectura completa.
```
