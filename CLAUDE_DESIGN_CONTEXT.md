...
| Existing dark spec | `claude_design/REDISE_O.md`, `globals.css`, `tailwind.config.snippet.ts`, `LOGIN-SPEC.md` |
| Assets | `public/logo-white.png`, `logo-black.png`, `favicon.svg`, `favicon.ico`, `placeholder.svg`, `robots.txt`, `sitemap.xml` |
